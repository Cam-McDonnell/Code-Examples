...
if (!empty($_POST["username"]) && !empty($_POST["password"])){
    ...
    $date = Date("Y/m/d");
    $slquery = "SELECT 1 FROM mcdoncam-db.Users WHERE username = '$username'";
    ...
    elseif($password != $cpassword){
         ...
         echo '<div class="form-actions"><a href="register.html" role="button" class="btn btn-lg btn-danger"> Click here to retry</a></div>';
          ...
          $query = "INSERT INTO `mcdoncam-db`.`Users` (userID,username,datejoined,password) 
          VALUES (NULL,'$username','$date','$sPassword')";
